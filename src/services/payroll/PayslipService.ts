...
<div class="card">
  ...
  <div class="body">
    ...
    ${(entry.feeSource === 'WORKER' && entry.feeAmount > 0) ? `<div class="row"><span>Administration Fee</span><strong>-£${entry.feeAmount.toFixed(2)}</strong></div>` : ''}
